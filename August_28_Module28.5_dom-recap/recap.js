...
3. dynamically add element to the dom: document.creteElement
    3-5: set value to the innerHTML

4. get and set value from/to a dom element
    4-6: use innerText (h1, p, h5, div, span, spam, strong)
    4-7: use value (input, textArea)
...
document.querySelectorAll('my-user li')